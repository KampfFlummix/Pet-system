	...
	(
		{
			...
			(
				...
				},
				{
					...
					"children" :
					(
						{"name":"HatchingMoney", "type":"text", "x":0, "y":0, "text": localeInfo.NAME_INPUT_PRICE, "r":1.0, "g":1.0, "b":1.0, "a":1.0, "all_align" : "center"},
					),
				},
				{
					"name" : "acceptbtn",
				...
				{ 
					...
					"children" :
					(
						{"name":"PetNamingTitle", "type":"text", "x":0, "y":0, "text":localeInfo.NAME_INPUT_TEXT, "all_align" : "center"},
					),
				},
			),
		},
